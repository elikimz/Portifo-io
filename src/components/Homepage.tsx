...
const Hero = () => {
  ...
  return (
    <>
      ...
      <section 
        className="h-screen flex items-center px-4"
        style={{
          background: 'linear-gradient(to right, #fafaec, #f4f3cd)', // Gradient background
        }}
      >
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between"> {/* Flex container */}
          
          {/* Image Card Section */}
          <div className="md:w-1/2 p-4 flex justify-center"> {/* Image section */}
            {imageUrl && (
          ...
          {/* Text Section */}
          <div className="md:w-1/2 p-4 text-center md:text-left"> {/* Text section */}
            <h1 className="text-6xl font-bold text-dark mb-4">
              Hi, I'm <span className="text-primary">Elikim</span>
            </h1>
            <p className="text-xl text-contrast mb-6">
